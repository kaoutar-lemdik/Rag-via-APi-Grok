...
# ============================================================
#        CHARGEMENT AVEC CACHE STREAMLIT
# ============================================================
...
def load_database(_embeddings):
    ...
    if not api_key:
        raise ValueError(
            "PINECONE_API_KEY non trouvée ! "
            "Ajoutez-la dans .env ou Streamlit secrets."
        )
...
def search_documents(database, query, k=TOP_K):
    """Recherche les documents les plus pertinents dans Pinecone."""
...
def get_sources(documents):
    """Retourne les sources sans doublons."""
    seen    = set()
    sources = []
...
# ============================================================
#          CLASSE (gardée pour compatibilité)
# ============================================================
